...
def enviar_telegram(id, msg_id="", msg="", func=""):
    if func == "send_msg":
        #requests.post("https://api.telegram.org/bot8507566279:AAGN5OQyN8dLhyc3bw8IovGMnfGtgaKpHAA/sendMessage", json={
        #            "chat_id": id,
        #           "text": f"{msg}"
        #        })
        ...
        with open(f"rest_api/componentes/audios/ondoku{msg}.mp3", "rb") as audio:
            #requests.post("https://api.telegram.org/bot8507566279:AAGN5OQyN8dLhyc3bw8IovGMnfGtgaKpHAA/sendAudio", data={"chat_id": id}, files={"audio": audio})
